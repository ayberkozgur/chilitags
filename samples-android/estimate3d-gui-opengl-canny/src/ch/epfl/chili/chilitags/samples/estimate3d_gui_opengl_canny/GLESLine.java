...
import ch.epfl.chili.chilitags.samples.estimate3d_gui_opengl_canny.shader.LineShader;
...
public class GLESLine {
	...
	private int positionHandle; //The handle to the a_position  attribute
	private int colorHandle; //The handle to the v_color uniform
